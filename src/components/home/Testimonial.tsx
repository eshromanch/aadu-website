...
import { testimonialData, testimonialData2 } from "@/data/homeData"
...
export function Testimonial() {
  return (
    <div className="w-full py-16 bg-neutral-offWhiteBlue">
      ...
      <SectionContainer className="flex flex-col lg:flex-row items-center gap-12 mt-12">
        {/* Left - Quote */}
        <div className="flex-1">
          <div className="relative">
            <Image
            ...
            />
            <Body24 className="text-neutral-bodyText mb-6 leading-relaxed">
              {testimonialData2.quote}
            </Body24>
            <div className="flex items-center gap-2">
              <Body20 className="text-primary-deepBlue">
                - {testimonialData2.author}
              </Body20>
            </div>
            <Body20Semibold className="text-neutral-bodyText">
              {testimonialData2.position}
            </Body20Semibold>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center">
            ...
            <Image 
              src={testimonialData2.image}
              alt={`${testimonialData2.author}, ${testimonialData2.position}`}
              width={500}
              height={500}
              className="rounded-2xl"
            />
